...
class TestController {
	...
	/**
	 * Returns a simple health status endpoint (global, API-independent).
	 *
	...
	#[ApiResponse(status: 200, description: 'API is healthy', example: ['status' => 'ok', 'service' => 'sg_apicore'])]
	...
	/**
	 * Public test endpoint with query validation and tenant/request context.
	 *
	 * @param ServerRequestInterface $request
	 * @return ResponseInterface
	 */
	...
	#[ApiResponse(
		...
		example: ['api' => 'public', 'version' => '1', 'code' => 'ABC', 'tenant' => 'default']
	)]
	...
	/**
	 * Partner endpoint with token and scope requirements.
	 *
	 * @param ServerRequestInterface $request
	 * @return ResponseInterface
	 */
	...
	/**
	 * User endpoint that requires a login context.
	 *
	 * @param ServerRequestInterface $request
	 * @return ResponseInterface
	 */
	...
	/**
	 * Endpoint shared between partner/user APIs requiring elevated scope.
	 *
	 * @param ServerRequestInterface $request
	 * @return ResponseInterface
	 */
	...
	/**
	 * Returns a paginated list and demonstrates filtering plus response caching metadata.
	 *
	 * @param ServerRequestInterface $request
	 * @return ResponseInterface
	 */
	...
	#[ApiCache(lifetime: 300, tags: ['sg_apicore_examples'], additionalVary: ['search', 'includeDraft'])]
	...
	/**
	 * Returns a single example item by numeric identifier.
	 *
	 * @param ServerRequestInterface $request
	 * @param int $id
	 * @return ResponseInterface
	...
	#[ApiCache(lifetime: 600, tags: ['sg_apicore_examples'])]
	...
	/**
	 * Creates a new example item and demonstrates body validation rules.
	 *
	 * @param ServerRequestInterface $request
	 * @return ResponseInterface
	 */
	...
	/**
	 * Demonstrates an endpoint requiring full TypoScript context.
	 *
	 * @param ServerRequestInterface $request
	 * @return ResponseInterface
	 */
	...
	/**
	 * Returns static in-memory data as a predictable template dataset.
	 *
	...
	/**
	 * Filters items by search term and draft visibility.
	 *
	...
	/**
	 * Normalizes common truthy values from query/body payloads.
	 *
	 * @param mixed $value
	 * @return bool
	 */
